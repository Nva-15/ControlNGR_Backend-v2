...
INSERT INTO tipos_usuario (id, codigo, nombre, descripcion, nivel_jerarquia, puede_solicitar, marca_asistencia, es_sistema) VALUES
 ...
 (6,  'gestor',     'Gestor',                    'Gestor de Tiendas y Almacen de Sistemas',  60,  1, 1, 0),
 (7,  'tecnico',    'Tecnico de Soporte',        'Personal de soporte tecnico',              10,  1, 1, 0),
 ...
 (11, 'asistente',  'Asistente de Almacen',      'Asistentes de almacen de sistemas',        10,  1, 1, 0);
...
INSERT INTO departamentos (id, nombre, descripcion) VALUES
 (1, 'Infraestructura y Soporte',      'Gerencia de TI y soporte tecnico'),
 (2, 'Soporte Tecnico',                'Atencion a usuarios y sistemas'),
 (3, 'NOC',                            'Monitoreo de redes y operaciones'),
 (4, 'HD',                             'Help Desk y atencion al cliente'),
 (5, 'Back Office',                    'Procesos administrativos y gestion'),
 (6, 'Tiendas y Almacen de Sistemas',  'Gestion de tiendas y almacen de sistemas');
...
INSERT INTO empleados (id, dni, nombre, cargo, departamento_id, nivel, descripcion, hobby, cumpleanos, ingreso, foto, activo, identificador, email) VALUES
 ...
 (8,  '75833543', 'Eli Neiser Vasquez Alarcon',       'Lider Tecnico (LT)',                   2, 'tecnico',    'Soporte TI', 'Futbol, Musica, Nadar', '1996-05-15', '2020-12-01', 'img/eli_neiser_vasquez_alarcon_1.png', 1, 'eli-neiser', 'eli.vasquez@ngr.com.pe');
...
INSERT INTO parametros_sistema (clave, valor, tipo_dato, descripcion) VALUES
 ('DIAS_POR_FERIADO_LABORADO',   '2',    'NUMERO',   'Dias de compensacion que se abonan por trabajar un feriado'),
 ('DIAS_VACACIONES_POR_ANIO',    '30',   'NUMERO',   'Dias de vacaciones que se abonan por cada año cumplido'),
 ('VACACIONES_ABONO_DESDE',      DATE_FORMAT(CURRENT_DATE, '%Y-%m-%d'), 'FECHA',
     'Solo se abonan automaticamente los aniversarios desde esta fecha. Lo anterior se registra con la carga inicial'),
 ('VALIDAR_IP_MARCACION',        'true', 'BOOLEANO', 'Si es true, solo se puede marcar asistencia desde los segmentos de red registrados'),
 ('TOLERANCIA_TARDANZA_MINUTOS', '5',    'NUMERO',   'Minutos de tolerancia antes de considerar tardanza'),
 ('EVIDENCIA_MAX_MB',            '10',   'NUMERO',   'Tamaño maximo del archivo de evidencia (foto o PDF)');
...
INSERT INTO segmentos_red (nombre, patron, descripcion) VALUES
 ...
 ('VPN',         '192.168.113.%', 'Conexion por VPN');
...
INSERT INTO tipos_solicitud (codigo, nombre, descripcion, descuenta_de, requiere_evidencia, requiere_motivo_licencia, tipo_dia_horario) VALUES
 ...
 ('compensacion',    'Compensacion por feriado',  'Descuenta del saldo de dias por compensar al ser aprobada',  'COMPENSACION', 0, 0, 'compensado'),
 ('descanso_medico', 'Descanso medico',           'Requiere adjuntar el certificado medico (foto o PDF)',       'NINGUNO',      1, 0, 'descanso_medico'),
...
INSERT INTO dias_feriados (fecha, descripcion) VALUES
 ...
 ('2027-06-07', 'Batalla de Arica y Dia de la Bandera'),
 ('2027-06-29', 'San Pedro y San Pablo'),
 ('2027-07-23', 'Dia de la Fuerza Aerea del Peru'),
 ('2027-07-28', 'Fiestas Patrias'),
 ('2027-07-29', 'Fiestas Patrias'),
 ('2027-08-06', 'Batalla de Junin'),
